# Generated by Django 5.2.4 on 2025-08-05 22:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0004_alter_articleanalysis_options_articleanalysis_user_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('trusted', 'Trusted'), ('untrusted', 'Untrusted'), ('neutral', 'Neutral')], default='neutral', max_length=20)),
            ...
            options={
                'verbose_name_plural': 'Domain Trust',
            },
        ),
        migrations.CreateModel(
            name='FlaggedContent',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('analysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flags', to='core.articleanalysis')),
